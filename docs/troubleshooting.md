...
- **Program never stops:** Headless runs use wall-clock and instruction limits. For stateful continuation, reset the session after a bounded continuation returns paused.
