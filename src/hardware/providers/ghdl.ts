...
export class GhdlProvider implements HardwareProvider {
  ...
  async capability(): Promise<ProviderCapability> { return { id: 'ghdl', version: this.version ?? 'unavailable', available: this.version !== null, ...(this.version === null ? { unavailableReason: 'ghdl executable not found' } : {}), actions: ['analyze', 'simulate'], languages: ['vhdl'], standards: ['87', '93', '02', '08'], artifactFormats: ['vcd', 'fst', 'ghw'] }; }
